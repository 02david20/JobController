...
KIND_CLUSTER ?= jobcontroller-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name jobcontroller-builder
	$(CONTAINER_TOOL) buildx use jobcontroller-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm jobcontroller-builder
	rm Dockerfile.cross
...
HELM_NAMESPACE ?= jobcontroller-system
