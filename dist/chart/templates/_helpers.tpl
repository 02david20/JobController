...
*/}}
{{- define "jobcontroller.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "jobcontroller.resourceName" -}}
{{- $fullname := include "jobcontroller.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "jobcontroller.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enable | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "jobcontroller.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
